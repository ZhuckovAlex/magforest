...
public class TurningPinfire {
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        ...
        double sy = 0;
        double sz = 0;
        if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ModBlocks.PINFIRE_ORE.get())
                && (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() == ModItems.AER_MIX.get()
                .asItem()))) {
            world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.AIR.getDefaultState(), 3);
            if (entity instanceof PlayerEntity) {
                ItemStack _stktoremove = new ItemStack(ModItems.AER_MIX.get());
            ...
            if (true) {
                new Object() {
                    ...
                    private void run() {
                        if (entity instanceof PlayerEntity) {
                            ItemStack _setstack = new ItemStack(ModItems.PRIMORDIAL_FIRE.get());
